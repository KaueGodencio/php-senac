...
<div class="container  bg-body mt-5 p-4 rounded-3" style="min-height: 600px;">
    ...
    <div class="d-flex justify-content-end my-2">
        <a class="btn btn-primary m-1" href="cadastro.php" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
